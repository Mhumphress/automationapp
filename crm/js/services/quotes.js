...
export async function sendQuote(quoteId) {
  ...
  const viewDoc = {
    ...
    userLimit: quote.userLimit || 0,
    extraUsers: quote.extraUsers || 0,
    seatMonthlyTotal: quote.seatMonthlyTotal || 0,
    recurring: quote.recurring || 0,
    recurringMonthly: quote.recurringMonthly || 0,
